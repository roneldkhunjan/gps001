...
<button class="btn btn-mini btn-info" style="margin-top:26px;">
											<i class="icon-bolt"></i>
<a href="#modal-form" role="button" class="white" data-toggle="modal" style="color:white;">Add Device</a>	
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									...
									<?php 
									$slno=1;
									$q=mysql_query("select * from device_make");
								...
								<div class="modal-header" style="background: #045e9f;">
									...
									<h4 class="white bigger">Please Add the Device Make & Model Details</h4>
								</div>
	<form class="form-horizontal" action="<?php echo base_url();?>device_make/add" method="POST">
								...
								<div class="control-group">
									<label class="control-label" for="form-field-1">Make</label>
