						...
						<?php	if(isset($msg2))
							...
							?>
								...
								<div class="infobox infobox-green  ">
										...
										<?php $cq= mysql_query("select sum(onlinetransferamount) as cnt from backend_onlinetransfer");
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									<thead>
										<tr>
											...
											<?php
											$slno=1;
											$q=mysql_query("SELECT * FROM `backend_onlinetransfer` p left join customers c on c.customer_id=p.customer_id");
