				...
				<div class="page-header position-relative">
				    ...
				    <div class="span12">
						...
						<?php	if(isset($msg2))
							...
							?>
				    <form class="form-horizontal" action="<?php echo base_url();?>stock_upload/uploaded" method="POST" enctype="multipart/form-data" >
				    
				      	<div class="span6">
				    	<div class="control-group">
									<label class="control-label" for="form-field-1">Upload Here</label>
									...
									<div class="controls">
										<input type="file"  name="csvdata" id="csvdata">
									  	...
									  	<div class="span6">
									<a href="<?php echo base_url();?>samplecsv/testupload.csv">Click here to see Sample File</a>
									</div>
