...
<div class="span9 infobox-container">
									<div class="infobox infobox-blue  ">
										...
										<?php
										$usrid=$user['id'];
										 $cq= mysql_query("SELECT count(co.customer_id) as cnt FROM `customer_orders` co join customers c on c.customer_id=co.customer_id join payment_list p on p.order_id=co.order_id where order_from='backend' and co.created_by='$usrid'");
										while($cres=mysql_fetch_array($cq))
										{
											$cnt=$cres['cnt'];
										}?>
									...
									<div class="infobox infobox-orange2  ">
										...
										<div class="infobox-data">
										<?php $scq= mysql_query("SELECT count(co.customer_id) as cnt FROM `customer_orders` co join customers c on c.customer_id=co.customer_id join payment_list p on p.order_id=co.order_id where order_from='backend' and approve_status='pending' and co.created_by='$usrid'");
										while($scres=mysql_fetch_array($scq))
										{
											$scnt=$scres['cnt'];
										}?>
									...
									<div class="infobox infobox-green  ">
										...
										<div class="infobox-data">
										<?php $lcq= mysql_query("SELECT count(co.customer_id) as cnt FROM `customer_orders` co join customers c on c.customer_id=co.customer_id join payment_list p on p.order_id=co.order_id where order_from='backend' and approve_status='approved' and co.created_by='$usrid'");
										while($lcres=mysql_fetch_array($lcq))
										{
											$lcnt=$lcres['cnt'];
										}?>
                                    ...
                                    <div class="infobox infobox-red  ">
										...
										<div class="infobox-data">
										<?php $rcq= mysql_query("SELECT count(co.customer_id) as cnt FROM `customer_orders` co join customers c on c.customer_id=co.customer_id join payment_list p on p.order_id=co.order_id where order_from='backend' and approve_status='rejected' and co.created_by='$usrid'");
										while($rcres=mysql_fetch_array($rcq))
										{
											$rcnt=$rcres['cnt'];
										}?>
