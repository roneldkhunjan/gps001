...
?>
				...
				<div class="page-header position-relative">
						<h1>
							...
							<a href="<?php echo base_url();?>stock_report/qc" class="btn btn-primary">Back</a>
						</h1>
					</div>
				    <div class="row-fluid">
				    <div class="span12">
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									...
									$q=mysql_query("SELECT * FROM `gps_model_details` where category_type='$cid' and device_id='$did' and status='$st'");
									while($res=mysql_fetch_array($q))
									{
									$category_type=$res['category_type'];
									$device_id=$res['device_id'];
									$total=$res['imie_number'];
									$status=$res['status'];
									?>
									<tr>
									<td><?php echo $slno;?></td>
									...
									<?php
					$sq=mysql_query("select * from gps_categories where category_id='$category_type'");
						...
						?>
									...
									<?php
	$qq=mysql_query("select * from gps_devices where device_id='$device_id'");
while($sqss=mysql_fetch_array($qq))
								...
								?>
									...
									?>
									<td><a href="<?php echo base_url();?>stock_report/showqc/<?php echo $category_type;?>/<?php echo $device_id;?>/<?php echo $status;?>"><?php echo $total;?></a></td>
