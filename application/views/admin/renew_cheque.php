		...
		<?php include 'include/sidebar2.php';?>
			...
			<div class="main-content">
				...
				<div class="page-header position-relative">
						<h1>
							Subscription Renewal Cheque Account List
							<small>
				    ...
				    <div class="span12">
						...
						<div class="infobox infobox-green" style="width: 250px;">
										...
										<?php $cq= mysql_query("select sum(chequeamount) as cnt from renew_cheque");
										while($cres=mysql_fetch_array($cq))
										{
											$cnt=$cres['cnt'];
										}?>
											<span class="infobox-data-number"><?php echo $cnt;?></span>
											<div class="infobox-content">Cheque Account Balance</div>
										</div>
									</div>
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									<thead>
										<tr>
											...
											<?php
											$slno=1;
											$q=mysql_query("SELECT p.customer_id,p.order_id,p.chequeamount,p.total_chequeamount,p.time_stamp,c.customer_first_name,c.customer_uid FROM `renew_cheque` p left join customers c on c.customer_id=p.customer_id");
											...
											//	$id=$res['id'];
												...
												$total_chequeamount=$res['total_chequeamount'];
											...
											<td><?php echo $total_chequeamount;?></td>
