...
?>	
					...
					<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
						...
						$qo=mysql_query("SELECT * FROM `customer_orders` co join customers c on c.customer_id=co.customer_id where order_from='backend' and approve_status='pending' and co.remarks='Waiting for Approval' and co.type_order='demo' order by co.appr_rej_date desc");
						...
						?>
								...
								<td><?php echo $srs['customer_uid'];?></td>
										...
										<td><a href="<?php echo base_url();?>demo_request/view_demo_order/<?php echo $custmainid;?>/<?php echo $order_id;?>" class="btn btn-small btn-primary no-border">Approve </a></td>	
	...
	?>
		...
		<div id="demo" style="background-color: #eff3f8;">
					...
					<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
						...
						$qo=mysql_query("SELECT * FROM `customer_orders` co join customers c on c.customer_id=co.customer_id join payment_list p on p.order_id=co.order_id where order_from='backend' and approve_status='pending' and co.remarks='Waiting for Approval' and co.type_order='demo' order by co.appr_rej_date desc");
