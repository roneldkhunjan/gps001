			...
			<div class="main-content">
				...
				<div class="page-header position-relative">
						<h1>
							...
							Subscription Renewal Order Waiting for Approval
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
						...
						$slno=1;
						$qo=mysql_query("Select *,DATE_ADD(installed_date, INTERVAL submonth MONTH) as expiry_date from r_installation i join customers c on c.customer_id=i.customer_id where i.installation_status='completed' and i.renew_approve_status='pending'");
...
while($sqss=mysql_fetch_array($qq))
								...
								<td><?php echo date("d-m-Y",strtotime($srs['installed_date']));?></td>
									<td><?php echo $srs['submonth'];?></td>
										...
										<td><a href="<?php echo base_url();?>subscription_renewal/approve/<?php echo $instatllation_id;?>/<?php echo $customer_id;?>/<?php echo $order_id;?>"  >Approve</a></td>
