...
<h3  style="margin-left: 143px;"># 204 Raheja Chamber, 12 Museum Road, Bangalore - 560 001</h3>

<table  border="1" style="width: 821px;font-size: 14px;border-bottom: black;
border-left: black;
border-right: black;margin-top: -15px;">
...
<?php
		 ...
		 $s_tax=(($subs_cost+$inst_cost+$sim_cost)*$s_tax_per)/100;

															$vat=($dev_cost_tot*$vatper)/100;
...
<b>Online Transfer:- State Bank Of India, A/c-10242758996, IFSC Code-SBIN0000814,B'lore.</b><br/>
...
<h1  style=" 
    margin-top: -30px;
    margin-bottom: -21px;margin-left:243px;font-size:30px;">PROFORMA INVOICE</h1>
<h1  style="
    margin-top: 15px;
