						...
						<?php	if(isset($msg2))
							...
							?>
								...
								<div class="infobox infobox-green  ">
										...
										<?php $cq= mysql_query("select sum(cashamount) as cnt from backend_cash");
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									<thead>
										<tr>
											...
											<?php
											$slno=1;
											$q=mysql_query("SELECT p.customer_id,p.order_id,p.cashamount,p.total_cashamount,p.time_stamp,c.customer_first_name,c.customer_uid FROM `backend_cash` p left join customers c on c.customer_id=p.customer_id");
