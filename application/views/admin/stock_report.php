...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									...
									$q=mysql_query("SELECT category_type,g.device_id as dd,total,count(i.device_id) as used,total-count(i.device_id) as remaining FROM installation  i right join total_stock  g on g.device_id=i.device_id group by g.category_type,g.device_id");
