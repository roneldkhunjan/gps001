		...
		<?php include 'include/sidebar2.php';?>
			...
			<div class="main-content">
				...
				<div class="page-header position-relative">
						<h1>
							Subscription Renewal Online Account List
							<small>
						...
						<?php	if(isset($msg2))
							...
							?>
								...
								<div class="infobox infobox-green  ">
										...
										<?php $cq= mysql_query("select sum(amt) as cnt from renew_online");
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									<thead>
										...
										<!--	<th>Cash Balance</th>-->
											...
											<?php
											$slno=1;
											$q=mysql_query("SELECT * FROM  renew_online s left join customers cu on s.customer_id=cu.customer_id ");
