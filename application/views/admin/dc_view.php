...
<?php
	...
	/*$iiq=mysql_query("select * from invoice_tb where order_id=$dcoid");
...
$neq=mysql_query("Select sum(noofdevice) as ndev,network,start_date,end_date from customer_order_details where customer_id='$id' and order_id='$dcoid'  group by order_id");
								...
								$end_date=$rneq['end_date'];
	                                                        $network=$rneq['network'];
								}

                                                  $nq=mysql_query("select * from network where id='$network'");
...
# 204 Raheja Chamber, 12 Museum Road, Bangalore - 560 001</a>
   ...
   <?php echo "#DC0".$invs."/".$invoice_year;?>
   </td>
   </tr></table></td></tr> 
	<tr>
	<td >
...
text-align: center;">PIN CODE</td></tr>
 ...
 <td style="height: 60px; width: 284px">  <?php echo $comp_contname1;?></td>
   ...
   <tr>
	...
	<a href="<?php echo base_url();?>dc"><img  src="<?php echo base_url();?>ck/back.png"/></a>
