...
<?php } ?>
		...
		<div class="control-group">
				...
				remark=document.getElementById('remark').value;
					...
					window.location.href="<?php echo base_url();?>order_details/payment_order_approved/"+cid+"/"+oid+"/"+encodeURIComponent(remark);
				}
				function rejectform()
				{
				...
				oid=document.getElementById('order_id').value;
					remark=document.getElementById('remark').value;
					window.location.href="<?php echo base_url();?>order_details/payment_order_reject/"+cid+"/"+oid+"/"+encodeURIComponent(remark);
				}
				...
				oid=document.getElementById('order_id').value;
					remark=document.getElementById('remark').value;
					window.location.href="<?php echo base_url();?>order_details/payment_order_pending_order/"+cid+"/"+oid+"/"+encodeURIComponent(remark);
				}
				</script>									