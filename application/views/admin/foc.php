...
o.order_id,o.order_date,f.order_value,
o.order_type
FROM
customer_orders o
join customers c on c.customer_id=o.customer_id join foc_payments f on f.customer_id=c.customer_id where  o.customer_type='foc' group by o.order_id
...
<td>OD<?php echo $ordrs['order_id']; ?></td>
											<td><?php echo $ordrs['order_value']; ?></td>
