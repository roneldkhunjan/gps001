...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									...
									$slno=1;
									$cid=array();
									$q=mysql_query("select * from customer_proof_details where status='rejected'");
									...
									<?php	if($cfrist!='')
										...
										<td><?php echo $res['cust_proof'];?></td>
											<td><?php echo date("d-m-Y",strtotime($res['rejected_date_time']));?></td>
