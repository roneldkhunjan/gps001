...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									...
									$q=mysql_query("select * from installation i join customers cs on cs.customer_id=i.customer_id join customer_orders co on co.order_id=i.order_id where co.type_order='demo' and installation_status='pending' and assign_engineer='assigned'  order by i.order_id desc");
...
?>									<div id="changestatus<?php echo  $iidd; ?>" class="modal hide" tabindex="-1">
	...
	<form class="form-horizontal" action="<?php echo base_url();?>demo_request/status_change" method="POST">
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									...
									$q=mysql_query("SELECT *  from installation i join customers cs on cs.customer_id=i.customer_id left join customer_orders c on c.order_id=i.order_id where c.type_order='demo' and i.installation_status='pending' and c.created_by='$mid'  and assign_engineer='assigned' and cs.account_type='demo'  order by i.order_id desc");
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									...
									$q=mysql_query("select * from installation i join customers cs on cs.customer_id=i.customer_id join customer_orders co on co.customer_id=i.customer_id where co.type_order='demo' and  installation_status='pending' and assign_engineer='assigned' and cs.account_type='demo'  order by order_id desc");
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									...
									$q=mysql_query("SELECT *  from installation i left join customer_orders c on c.order_id=i.order_id join customers cs on cs.customer_id=i.customer_id where  c.type_order='demo' and i.installation_status='pending' and c.created_by='$mid'  and assign_engineer='assigned' and cs.account_type='demo' order by i.order_id desc");
