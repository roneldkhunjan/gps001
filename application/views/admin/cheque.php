				...
				<div class="page-header position-relative">
				    ...
				    <div class="span12">
						...
						<div class="infobox infobox-green" style="width: 250px;">
										...
										<?php $cq= mysql_query("select sum(chequeamount) as cnt from backend_cheque");
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									<thead>
										<tr>
											...
											<?php
											$slno=1;
											$q=mysql_query("SELECT p.customer_id,p.order_id,p.chequeamount,p.total_chequeamount,p.time_stamp,c.customer_first_name,c.customer_uid FROM `backend_cheque` p left join customers c on c.customer_id=p.customer_id");
