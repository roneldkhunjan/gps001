		...
		<?php include 'include/sidebar2.php';?>
			...
			<div class="main-content">
				...
				<div class="page-header position-relative">
						<h1>
							Subscription Renewal Online Transfer Account List
							<small>
						...
						<?php	if(isset($msg2))
							...
							?>
								...
								<div class="infobox infobox-green  ">
										...
										<?php $cq= mysql_query("select sum(onlinetransferamount) as cnt from renew_onlinetransfer");
										while($cres=mysql_fetch_array($cq))
										{
											$cnt=$cres['cnt'];
										}?>
											<span class="infobox-data-number"><?php echo $cnt;?></span>
											<div class="infobox-content">Online Transfer Account Balance</div>
										</div>
									</div>
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									<thead>
										<tr>
											...
											<?php
											$slno=1;
											$q=mysql_query("SELECT * FROM `renew_onlinetransfer` p left join customers c on c.customer_id=p.customer_id");
											...
											//	$id=$res['id'];
												...
												$onlinetransferamount=$res['onlinetransferamount'];
												$total_ontranferamount=$res['total_ontranferamount'];
											...
											<td><?php echo $onlinetransferamount;?></td>
											<td><?php echo $total_ontranferamount;?></td>
