...
<div class="main-container container-fluid">
		...
		?>
				...
				$ss1=mysql_query("select * from customers where customer_id='$cid'");
							...
							<?php
							$i=0;
								$q=mysql_query("select * from customer_order_details where customer_id='$id' and order_id='$order_id' and assign='pending' ");
...
while($sqss=mysql_fetch_array($qq))
		...
		<select name="<?php echo "imieno".$i; ?>"	id="<?php echo "imieno".$i; ?>"	onchange="getmodelid(this.value,<?php echo $i;?>,<?php echo $catid;?>,<?php echo $devid;?>);checkimei(this.value,<?php echo $i;?>,<?php echo $catid;?>,<?php echo $devid;?>);">
