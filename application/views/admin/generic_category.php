...
<button class="btn btn-mini btn-info" style="margin-top:26px;">
											<i class="icon-bolt"></i>
<a href="#modal-form" role="button" class="white" data-toggle="modal" style="color:white;">Add Generic Category</a>	
...
<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
									...
									<?php 
									$slno=1;
									$q=mysql_query("select * from gps_categories where type='generic' order by category_id desc");
	...
	<form class="form-horizontal" action="<?php echo base_url();?>generic_category/add" method="POST">
							
								<div class="modal-body overflow-visible">
									<div class="row-fluid">
										
									<div class="control-group">
									<label class="control-label" for="form-field-1">Generic Category</label>
								...
								<div class="control-group">
									<label class="control-label" for="form-field-1">Item Code</label>
