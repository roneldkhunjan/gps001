...
$state=$order['state'];
					...
					<tr><td>
<img style="height:90px;" align="absmiddle" src="<?php echo base_url();?>ck/mainlogo_oss.png" alt="" />
<br/>
<a>
<h1  style=" 
    margin-top: 0px;
...
<h1  style="
    margin-top: 15px;
    margin-bottom: -24px;margin-left:80px;"  >OSS TECHNOLOGIES PRIVATE LIMITED</h1>
...
border-right: black;margin-top: 0px;">
	...
	<td>#INV<?php echo str_pad($invs, 4, '0', STR_PAD_LEFT)."/".$invoice_year; ?></td>
	</tr>
	<tr>
<?php
if($order['comp_email']!='')
...
<br/>
<br/>
<b>Payment :- Cheque/DD/Payorder in favour of "OSS Technologies Private Limited"</b><br/>
<b>Online Transfer:- HDFC Bank, A/c No-50200000294376, IFSC Code-HDFC0000184, B'lore.</b><br/>
<b>For OSS TECHNOLOGIES PRIVATE LIMITED</b>
<br/>
<br/>
<table >
...
<h1  style=" 
    ...
    if($inv=="802"||$type=="Dealer" || $invs=="47"|| $invs=="48"|| $invs=="34"|| $invs=="46" || $invs=="53" || $invs=="509" || $inv=="893"|| $inv=="895" || $inv=="899" || $inv=="902" || $inv=="878" || $inv=="906" || $inv=="904" || $inv=="945" || $inv=="731" || $inv=="737" || $inv=="752" || $inv=="918" )
    {
		echo "TAX INVOICE";
	}
	else
...
<h1  style="
    margin-top: 15px;
    margin-bottom: -24px;margin-left:73px;"  >OSS TECHNOLOGIES PRIVATE LIMITED</h1>
