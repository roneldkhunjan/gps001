			...
			<div class="main-content">
				...
				<div class="page-header position-relative">
					...
					<table cellpadding="0" cellspacing="3" border="0" class="table table-striped table-bordered" id="example">
						...
						$qo=mysql_query("SELECT * FROM `customer_orders` co join customers c on c.customer_id=co.customer_id join payment_list p on p.order_id=co.order_id where order_from='backend' and approve_status='pending' and co.created_by='$usrid' group by p.order_id");
