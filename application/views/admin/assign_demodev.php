		...
		<?php include 'include/sidebar2.php';?>
			...
			<div class="main-content">
				...
				<div class="page-header position-relative">
					...
					<form class="form-horizontal" action="<?php echo base_url();?>assign_device/assign_demo" method="POST">
...
//$iiq=mysql_query("select count(instatllation_id) as cnt from installation where customer_id='$id' and order_id='$order_id' and device_id=$devid");
...
<?php } ?>
		...
		<input type="hidden" name="cnt" id="cnt" value="<?php echo $lncnt;?>"/>				
						<div class="control-group">
