...
<input type="hidden" name="r_invid" id="r_invid" value="<?php echo $r_invid;?>"/>
...
//	onlinetype=document.getElementById('onlinetype').checked ? document.getElementById('onlinetype').value : '';
	...
	r_invid=document.getElementById('r_invid').value;
	/*if(ful=='fullpayment')
	{
...
window.top.location.href="<?php echo base_url();?>renew_payment/received/?msg1="+abc;
