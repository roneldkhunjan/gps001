...
?>
										...
										<input type="radio" id="adv" name="type" value="advance" onclick="getbtndiv();getsummary();">

										<label class="lbl" for="id-disable-check"> Advance</label>

										&nbsp; &nbsp;

										<input type="radio" id="ful" name="type" value="fullpayment" onclick="getbtndiv();getsummary();">
...
<!--return isNumberKey(event)-->
						 <input type="text" name="amount" id="amount" onkeypress="return numbersonly(event);"   onkeyup="putamount(this.value);getsummary();" />
						   <input type="text" name="advamount" id="advamount" onkeypress="return numbersonly(event);"   onkeyup="putamount(this.value);getsummary();" onchange="enableblock(this.value);" style="visibility:hidden;margin-left: -223px;"/>
...
vtax=document.getElementById('ovat').value;
	...
	servicetax+=((Number(subcostt[i])*Number(noofdevices[i]))+(Number(instchargee[i])*Number(noofdevices[i])))*parseFloat(stax/100);
