...
<td>OD<?php echo $ordrs['order_id']; ?></td>
											<td>RINV<?php echo $ordrs['id']; ?></td>

<td><?php echo date("d-m-Y",strtotime($ordrs['paid_on'])); ?></td>

											<td>

												<?php echo "Renew Invoice"; ?>
											...
											<td >
													...
													<a class="green" href="<?php echo base_url();?>subscription_renewal/renew_invoice?id=<?php echo $ordrs['customer_id']; ?>&inv=<?php echo $ordrs['id']; ?>">

														RINV<?php echo str_pad($ordrs['id'], 4, '0', STR_PAD_LEFT); ?>
