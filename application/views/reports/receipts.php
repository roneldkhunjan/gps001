									...
									<thead>
										<tr>
											...
											<td><div class="hidden-phone visible-desktop action-buttons">
													<a href="<?php echo base_url();?>receipts/view/<?php echo $customer_id;?>/<?php echo $oid;?>/<?php echo $total_amount;?>" class="btn btn-small btn-info">View</a></div></td>
											<!--<td><?php echo $cashamount;?></td>
