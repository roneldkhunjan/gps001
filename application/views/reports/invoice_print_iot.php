...
<h1  style="
    margin-top: 15px;
    margin-bottom: -24px;margin-left:39px;"  >IOT RESEARCH LABS PRIVATE LIMITED</h1>
...
<table  border="2" style="width: 821px;font-size: 14px;">
	...
	<td>#INV<?php echo str_pad($invsiot, 4, '0', STR_PAD_LEFT)."/2014-15"; ?></td>
	</tr>
	<tr>
<?php
if($order['comp_email']!='')
...
<p ><b>Payment :- Cheque/DD/Payorder in favour of "IoT Research Labs Private Limited"</b></p>
<p ><b>Online Transfer:- Federal Bank , A/c-21980200000154, IFSC Code-FDRL0002198,B'lore.</b></p>
<p ><b>For IoT Research Labs Private Limited</b></p>
