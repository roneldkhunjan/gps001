								...
								<table cellpadding="0" cellspacing="3" border="0" class="table" id="customer_sim_details">
									...
									<tbody id="reading_data">
										...
										while($res=mysql_fetch_array($q)){
											...
											if($simno!='' && $simno!='No Sim Chosen' && $simno!='0'){
												$subsactive++;
											...
											<tr class="parent" id="<?php echo $cid;?>">
												...
												<td class="editable" id="reading_<?php echo $res['instatllation_id'];?>" data-id="<?php echo $res['instatllation_id']; ?>" data-dtype="inst"><?php echo $simno;?></td>
												<td><?php echo $res['device_name'];?></td>
												<td><?php echo $res['demo_device_type'];?></td>
												<td><?php echo "CID".$cid." - ".$res['customer_first_name'];?></td>					
												<td>Active</td>
												<td  class="editable" data-type="select" data-source="{'Active': 'Active', 'Inactive': 'Inactive'}" id="reading_<?php echo $res['instatllation_id'];?>" data-id="<?php echo $res['instatllation_id']; ?>" data-dtype="sim_stat" data-value="<?php echo $sim_status;?>"><?php echo $sim_status;?></td>
											</tr>
											<?php	
										}
										...
										while($res=mysql_fetch_array($q1)){
											...
											<tr class="parent" id="<?php echo $cid;?>">
												<!--<td><?php echo $slno;?></td>-->
												<td><?php echo $res['imie_no'];?></td>
												<td class="editable" id="reading_<?php echo $res['r_id'];?>" data-id="<?php echo $res['r_id']; ?>" data-dtype="r_inst"><?php echo $simno;?></td>
												<td><?php echo $res['device_name'];?></td>
												<td><?php echo $res['demo_device_type'];?></td>
												<td><?php echo "CID".$cid." - ".$res['customer_first_name'];?></td>					
												<td>Expired</td>
												<td  class="editable" id="reading_<?php echo $res['r_id'];?>" data-id="<?php echo $res['r_id']; ?>"  data-type="select" data-source="{'Active': 'Active', 'Inactive': 'Inactive'}" data-dtype="r_sim_stat" data-value="<?php echo $sim_status;?>"><?php echo $sim_status;?></td>
											</tr>
											<?php	
											}
										}
...
<div class="clearfix">
													<div class="grid4" style="background-color: #EDFFF0;">
														<span class="grey">
													...
													<div class="grid4" style="background-color: #FFEDED;">
														<span class="grey">
													...
													<div class="grid4" style="background-color: #EDFFF0;">
														<span class="grey">
															<i class="icon-save icon-2x green"></i>
															<h5>SIM - Active</h5>
														</span>
														<h4 class="bigger"><?php echo $simactive; ?></h4>
													</div>

													<div class="grid4" style="background-color: #FFEDED;">
														<span class="grey">
															<i class="icon-save icon-2x red"></i>
															<h5>SIM - Inactive</h5>
														</span>
														<h4 class="bigger"><?php echo $siminactive; ?></h4>
													</div>
												</div>		
<div class="hr hr8 hr-double"></div>
							</div>
